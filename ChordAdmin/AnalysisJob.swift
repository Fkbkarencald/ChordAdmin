...
/// Deprecated: simple single-chord chart output is no longer generated by the pipeline.
...
enum JobStatus: String, Codable, Sendable {
    ...
    /// Deprecated: kept for decoding older `job.json` files; the pipeline never enters this state.
...
struct AnalysisJob: Codable, Identifiable, Sendable {
    ...
    /// Deprecated: `chord.chart.simple.json` is never written by the current pipeline.
    var chordChartSimplePath: String?
    /// Deprecated: see `chordChartSimplePath`.
    var chordChartSimpleBarCount: Int?
    /// Deprecated: see `chordChartSimplePath`.
    var chordChartSimplePreview: [ChordChartSimpleBarEntry]?
    /// Cache invalidation version; must match `AppConfig.analysisPipelineVersion`.
    var analysisPipelineVersion: Int?
